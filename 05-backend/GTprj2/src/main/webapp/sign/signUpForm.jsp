...
<c:if test="${not empty message and not empty type}">
	<script type="text/javascript">
		...
		if (type === "success") {
			...
			window.location.href = "${pageContext.request.contextPath}/main?action=signUpForm";
		}
	</script>
</c:if>
					...
					<div class="col-md-8 col-lg-6 col-xxl-3">
						<div class="card mb-0">
							<div class="card-body">
								...
								<form method="post"
									action="${pageContext.request.contextPath}/main?action=signUp">
									<input type="hidden" name="action" value="signUp">
									...
									<!-- 수정: a 태그를 button 태그로 변경 -->
									<button type="submit"
										class="btn btn-primary w-100 py-8 fs-4 mb-4">Sign Up</button>

									<div class="d-flex align-items-center justify-content-center">
										<p class="fs-4 mb-0 fw-bold">Already have an Account?</p>
										<a class="text-primary fw-bold ms-2"
											href="${pageContext.request.contextPath}/main?action=signInForm">Sign
											In</a>
									</div>
								</form>
							</div>
