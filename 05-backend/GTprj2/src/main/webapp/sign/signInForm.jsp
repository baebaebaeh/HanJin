  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        ...
        <p class="text-center">로그인만 해도 운동 절반은 한 거예요!</p>

        <!-- 로그인 폼 -->
        <form method="post" action="${pageContext.request.contextPath}/main?action=signIn">
            <input type="hidden" name="action" value="signIn">

            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">User Email</label>
                <input type="text" name="userEmail" placeholder="아이디" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
            </div>
            <div class="mb-4">
                <label for="exampleInputPassword1" class="form-label">Password</label>
                <input type="password" name="userPassword" placeholder="비밀번호" class="form-control" id="exampleInputPassword1" required>
            </div>
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a class="text-primary fw-bold" href="${pageContext.request.contextPath}/main?action=forgotPasswordForm">Forgot Password?</a>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-center">
                ...
                <a class="text-primary fw-bold ms-2" href="${pageContext.request.contextPath}/main?action=signUpForm">Create an account</a>
            </div>
        </form>
    </div>
            </div>
