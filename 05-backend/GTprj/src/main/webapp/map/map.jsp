...
<%
    // 파일 경로 설정 (상대 경로 사용)
    String filePath = "C:/SSAFY/key/map_key.txt"; // 절대 경로로 설정
    String fileContent = "";

    try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
        fileContent = br.readLine(); // 파일의 첫 줄을 읽어옴
    } catch (IOException e) {
        e.printStackTrace();
    }
%>
...
<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=<%=fileContent%>"></script>
