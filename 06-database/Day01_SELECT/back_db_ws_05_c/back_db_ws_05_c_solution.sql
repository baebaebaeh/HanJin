...
select * from board ______ ____ _____(_________) ____, ___ ____;

#11. user 에서 id의 세번째 글자가 ‘o’ 인 data를 출력하시오.
select * from user _____ ________(__, __,__) __ '_';

#12. board 에서 content의 공백을 모두 ‘+’ 로 치환해서 출력하시오.
select _______(______, '___', '_') '치환' from board; 

#13. board 에서 writer를 중복없이 출력하시오.
select ___________ writername from board;
